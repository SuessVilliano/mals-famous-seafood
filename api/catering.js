export default async function handler(req, res) {
  ...
  const { firstName, lastName, email, phone, eventDate, eventLocation, guestCount, eventType, menuNotes, budget } = req.body;

  if (!firstName || !email || !eventDate || !eventLocation || !guestCount) {
      ...
      await fetch(`https://services.leadconnectorhq.com/conversations/messages/outbound`, {
        ...
        body: JSON.stringify({
          ...
          html: `
            ...
            <p><strong>Menu Notes:</strong> ${menuNotes || 'None'}</p>
            <hr>
